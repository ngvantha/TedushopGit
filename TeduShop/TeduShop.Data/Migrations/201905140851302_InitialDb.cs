    ...
    public partial class InitialDb : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        MataKeyword = c.String(maxLength: 256),
                        MataDescription = c.String(maxLength: 256),
                        Status = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.PostCategoris", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 50),
                        Deparment = c.String(nullable: false, maxLength: 50),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        ValueString = c.String(nullable: false, maxLength: 50, unicode: false),
                        ValueInt = c.Int(),
                    })
                .PrimaryKey(t => t.ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "CategoryID", "dbo.PostCategoris");
